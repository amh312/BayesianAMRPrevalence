#####BAYESIAN ESTIMATION OF ANTIMICROBIAL RESISTANCE (BEAR) - RUN
...
sims <- data.frame(rbind(PENsim,AMPsim,OXAsim,SAMsim,TZPsim,CZOsim,CXMsim,            #Assemble precision analysis data frame
